...
<template>
  ...
  <div id="top">
    <header role="banner">
      <h1>Josh HTML5 Test Page</h1>
      <p>This is a test page filled with common HTML elements to be used to provide visual feedback whilst building CSS
        systems and frameworks. Change the comments to select a different Bootstrap CDN style.</p>
    </header>
    <nav role="navigation">
      <ul>
        <li>
  ...
  p q r s t u v w x y z { | } ~ &
    ...
    <footer role="contentinfo">
      <p>Made by <a href="https://twitter.com/cbracco">@cbracco</a>. Code on <a
          href="https://github.com/cbracco/html5-test-page">GitHub</a>.</p>
    </footer>
  </div>
